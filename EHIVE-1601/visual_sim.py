...
# EVs (WORLD COORDS)
# =========================
from ev_dataset import EV_DATASET

evs = [
    EV("EV1", 0.20, 120, 60, 1.0, 0, 0, **EV_DATASET[0]),
    EV("EV2", 0.80, 40, 50, 0.2, 2, 0, **EV_DATASET[3]),
    EV("EV3", 0.10, 150, 70, 1.0, 0, 5, **EV_DATASET[1]),
    EV("EV4", 0.50, 80, 45, 0.3, 3, 5, **EV_DATASET[7]),
]
...
# =========================
# STATIONS (SNAPPED TO ROADS)
# =========================
stations = [
    Station("S1", 50, *nearest_node((8, 4))),
    Station("S2", 30, *nearest_node((12, 4))),
]
...
while True:
    ...
    # -------------------------
    # DRAW ROAD NODES (DEBUG / VISUAL CLARITY)
    # -------------------------
    for n in ROAD_NODES:
        pygame.draw.circle(screen, NODE_COLOR, to_screen(n), 4)
    ...
    for st in stations:
        ...
        pygame.draw.rect(screen, GREEN, (sx-16, sy-16, 32, 32))
        screen.blit(FONT.render(st.station_id, True, BLACK), (sx-14, sy-40))
